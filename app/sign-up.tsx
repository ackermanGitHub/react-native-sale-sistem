...
export default function SignUp() {
    ...
    return (
        <View style={tw`flex-1 justify-center items-center`}>
            ...
            <Pressable onPress={googleSignUpHandler} style={tw`w-4/5 max-w-[240px] mt-2 gap-4 bg-white dark:bg-slate-700 rounded h-12 flex-row justify-center items-center`}>
