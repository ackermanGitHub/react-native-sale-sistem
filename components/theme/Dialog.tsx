...
export const DialogComponent: React.FC<DialogComponentProps> = ({ isVisible, children, onClose, title, text, callback, type }) => {
    ...
    return (
        <View style={tw`w-full h-full bg-transparent  justify-center items-center`}>
            ...
            <View style={tw`w-4/5 h-1/2 bg-white dark:bg-slate-700 pt-10 relative rounded-lg shadow-lg border-slate-300 dark:border-slate-700 dark:shadow-slate-300 border-2 border-solid justify-start items-center`}>
